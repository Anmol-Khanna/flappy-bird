...
AABB::AABB(glm::vec3 min, glm::vec3 max)
    : min_{min},
      max_{max},
      vertices{// front face
               max_[0], min_[1], min_[2], max_[0], min_[1], max_[2], max_[0],
               max_[1], max_[2], max_[0], min_[1], min_[2], max_[0], max_[1],
               max_[2], max_[0], max_[1], min_[2],
               // back face
               min_[0], min_[1], min_[2], min_[0], min_[1], max_[2], min_[0],
               max_[1], max_[2], min_[0], min_[1], min_[2], min_[0], max_[1],
               max_[2], min_[0], max_[1], min_[2],
               // left face (actually is right face????)
               min_[0], min_[1], min_[2], max_[0], min_[1], min_[2], max_[0],
               max_[1], min_[2], min_[0], min_[1], min_[2], max_[0], max_[1],
               min_[2], min_[0], max_[1], min_[2],
               // right face
               min_[0], min_[1], max_[2], max_[0], min_[1], max_[2], max_[0],
               max_[1], max_[2], min_[0], min_[1], max_[2], max_[0], max_[1],
               max_[2], min_[0], max_[1], max_[2],
               // top face
               min_[0], max_[1], min_[2], max_[0], max_[1], min_[2], max_[0],
               max_[1], max_[2], min_[0], max_[1], min_[2], max_[0], max_[1],
               max_[2], min_[0], max_[1], max_[2],
               // bottom face
               min_[0], min_[1], min_[2], max_[0], min_[1], min_[2], max_[0],
               min_[1], max_[2], min_[0], min_[1], min_[2], max_[0], min_[1],
               max_[2], min_[0], min_[1], max_[2]} 
...
{ // constructor start
  ...
  glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 0,
                        (void*)0);  // let OpenGL figure the stride out itself-
  ...
  // @TODO(anmol): pass it the camera viewmatrix uniform here, after linking the
  // program
...
void AABB::render(glm::mat4 transform) {
  ...
  glBindVertexArray(VAO);
  glDrawArrays(GL_TRIANGLES, 0, 36); // Each tri needs 3 verts, so third param * 3 should = capacity of vertices[]
  glEnableVertexAttribArray(0);  
  /*
...
void AABB::render(glm::mat4 transform, glm::mat4 model) {
  glUseProgram(AABBShaderProgram);
  GLint loc = glGetUniformLocation(AABBShaderProgram, "viewProjection");
  if (loc != -1) {
    glUniformMatrix4fv(loc, 1, GL_FALSE, glm::value_ptr(transform));
  }
  GLint locModel = glGetUniformLocation(AABBShaderProgram, "model");
  if (locModel != -1) {
    glUniformMatrix4fv(locModel, 1, GL_FALSE, glm::value_ptr(model));
  }

  glBindVertexArray(VAO);
  glDrawArrays(GL_TRIANGLES, 0, 36);  // Each tri needs 3 verts, so third param
                                      // * 3 should = capacity of vertices[]
  glEnableVertexAttribArray(0);
}
